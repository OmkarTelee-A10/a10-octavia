...
class MemberFlows(object):
    ...
    def _get_delete_member_networking_subflow(self):
        ...
        #VLAN
        vlan_subflow = self.get_delete_vlan_network_handler_subflow()
        flat_subflow = self.get_delete_flat_network_handler_subflow()
    ...
    def get_delete_flat_network_handler_subflow(self):
        flat_network_handler_subflow = linear_flow.Flow(a10constants.FLAT_DELETE_NET_HANDLER_SUBFLOW)

        return flat_network_handler_subflow

    def get_delete_vlan_network_handler_subflow(self):
